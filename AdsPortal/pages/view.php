...
if(isset($_POST['srh'])){ $sr=$_POST['srh']; echo "sr";}
...
<div class="topnav" id="myTopnav">
  ...
  <input type="submit" value="GO" class="btn btn-primary" style="float:right; margin-top:8px;"/>
 <div style="float:right;margin-top:8px;">

 <input type="text" placeholder="Search Tags..." name="srh" class="form-control" style="width:99%;" /> 
...
?>
<div class="col-sm-12">
<img src="adimages/<?php echo $rs['img']; ?>" alt="img" height="400" style="width:100%;" />
</div>

</div>

<div class="col-sm-4" style="background-color:whitesmoke; border:1px solid black;"><br>
<h4><?php echo $rs['title']; ?></h4><br>
<h6><?php 
...
echo ucwords($rw['name'])."<br> Contact: +91 -".$rw['mobile']; ?>
</h6><br>
