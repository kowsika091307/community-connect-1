...
$folder = "C:/xampp/htdocs/AdsPortal/pages/adimages/"; $rd = round(microtime(true));
 ...
 $status="approved";
    ...
    if ($result) {
		echo "<h6 style='color:green; font-weight:bold;' align='center'>Ad has been created by admin successfully</h6>";
     } else {
...
?>
<form method="post" action="place_ad.php" enctype="multipart/form-data">
    ...
    $('#items').change(function () {
        ...
        if (item_id !== "") {
            ...
            $('#price').val(''); // Clear the field if no item is selected
        }
    });
});
